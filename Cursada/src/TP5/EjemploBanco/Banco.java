...
public class Banco {
	...
	static final int CANTIDAD_CUENTAS   = 1580;
	...
	public static void main(String[] args) {
		...
		long tiempoFin = System.currentTimeMillis();
		System.out.println("preparacion de las estructuras: " + ((float)(tiempoFin - tiempoInicio)/1000) + " segundos");
